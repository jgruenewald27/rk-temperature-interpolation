...
packages <- c("knitr", "tidyverse", "dplyr", "ggplot2", "sf", "sp", "raster", "terra", 
              "stars", "tmap", "gstat", "spdep", "spatialreg", "spatstat", "automap", 
              "nlme",  "scales", "caTools", "randomForest", "corrplot", "mgcv", "moments",
              "gridExtra", "lattice", "OpenStreetMap")
...
```{r}
temp_shm.ex$gam_residuals <- gam_all_mm$residuals
