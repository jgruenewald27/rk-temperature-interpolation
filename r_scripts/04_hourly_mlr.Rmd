...
This script loops over hourly timestamps from 2023-07-01 to 2023-07-12 and fits 
per-hour MLR (plus a z-standardized MLR with robust HC3 inference and 
relative-importance scores), stores model performance and residuals, and 
generates per-hour directional variogram maps/fits of the MLR residuals to 
diagnose spatial autocorrelation and anisotropy.
...
output_dir <- "../MLR_ANBH_07_2023_12days"
