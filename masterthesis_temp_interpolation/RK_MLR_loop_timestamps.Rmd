...
end_date   <- as.POSIXct("2023-07-01 03:00:00", tz = "Europe/Berlin")
...
Plots to analyse model performance metrics for entire month
-> Likely not in report as plots might be too crowded. Maybe something for the
Appendix if they contain some additional input.
