...
```{r}
mlr_timestamp_sel_469139 <- lm(hm_temp ~ elevation_z + canopy_height_z + building_height_z, data = sel_469139)
summary(mlr_timestamp_sel_469139)

par(mfrow=c(2,2))
plot(mlr_timestamp_sel_469139)
par(mfrow=c(1,1))
```

```{r}
mlr_timestamp_sel_469140 <- lm(hm_temp ~ elevation + canopy_height + building_height, data = sel_469140)
summary(mlr_timestamp_sel_469140)

par(mfrow=c(2,2))
plot(mlr_timestamp_sel_469140)
par(mfrow=c(1,1))
```


```{r}
mlr_timestamp_sel_469141 <- lm(hm_temp ~ elevation + canopy_height + building_height, data = sel_469141)
summary(mlr_timestamp_sel_469141)

par(mfrow=c(2,2))
plot(mlr_timestamp_sel_469141)
par(mfrow=c(1,1))
```
...
Create a variograms for the regression residuals 
```{r}
