...
```{r}
ggplot(moran_results, aes(x = hour, y = moran_i)) +
  geom_line() +
  geom_point(aes(color = p_mc < 0.05)) +  # color points if MC test is significant
  geom_hline(yintercept = 0, linetype = "dashed") +
  labs(title = "Moran's I (Asymptotic & Monte Carlo) over July 1, 2023",
       x = "Time", y = "Moran's I") +
  theme_minimal()
```
