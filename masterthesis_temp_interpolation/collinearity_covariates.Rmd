...
corr <- cor(covariates_df[c("elevation", "canopy_height", "building_height")], use = "pairwise.complete.obs")  

# Visualize the correlation matrix as a color heatmap, with values and formatted labels
png("../plots/correlation_covariates_plot.png", width = 2000, height = 1600, res = 300)
