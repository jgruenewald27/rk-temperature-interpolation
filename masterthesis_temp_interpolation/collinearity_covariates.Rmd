...
# save original canopy height raster
tch_orig <- tch    
...
tch_cooling <- focal(tch_orig, w = w, fun = sum, na.rm = TRUE)

par(mfrow = c(2, 1), oma = c(0, 1, 0, 1))

plot(tch_orig, main = "Original Tree Canopy Height")
plot(tch_cooling, main = "Gaussian Tree Cooling Effect (60 m)")
```
...
mlr_residuals <- read.csv(
  "../MLR_07_2023_12days/mlr_residuals_all.csv",
