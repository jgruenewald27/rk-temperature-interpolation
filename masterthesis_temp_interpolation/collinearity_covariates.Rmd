...
summary(covariates_df[c("elev", "canopy", "bldg")])  

# Compute correlation matrix for elev, canopy, and bldg, using all available non-missing pairs
corr <- cor(covariates_df[c("elev", "canopy", "bldg")], use = "pairwise.complete.obs")  
