...
Each hour was modelled using a separate multiple linear regression with z-standardized covariates. 
Areas show the proportional contribution of each covariate to the total model R² for that hour.",
    ...
    theme(
      plot.caption.position = "plot",   # places caption in bottom-right corner
