...
mod  <- rast("../RK_07_2023_12days/rk_predictions/2023-07-09_1400_rk_prediction_map.tif")
ref5 <- rast("../data/stadtklimaanalyse_2023/2_22_074_ist_t14_rev01.tif")
river <- st_read("../data/waterways/waterways_HD.gpkg")                 
landuse <- st_read("../data/copernicus_LULC/DE522L1_HEIDELBERG_UA2018_v013.gpkg")
...
p_rk_map <- ggplot() +
  ...
  labs(title = "RK Model Temperature Distribution",
...
p_ref_map <- ggplot() +
  ...
  annotation_north_arrow(location = "tl", which_north = "true", width = unit(0.9, "cm"),
                         style = north_arrow_orienteering) +
  labs(title = "Urban Climate Analysis Heidelberg (2023)",
