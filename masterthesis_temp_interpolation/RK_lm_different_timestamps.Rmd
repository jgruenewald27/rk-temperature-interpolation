...
rk_metrics <- read.csv("../rk_results/rk_metrics.csv")
...
# Save plot
ggsave("../plots/rk_metrics_by_day_01-01-2023.png", plot = p_rk, width = 12, height = 8, dpi = 300)
