...
lm_metrics <- read.csv("../rk_results_testweek/lm_model_performance_summary.csv")
...
p_lm <- ggplot(lm_df_plot, aes(x = hour, y = value, color = metric, group = metric)) +
  ...
  scale_color_manual(values = c("r_squared" = "#6699CC",
                                "adj_r_squared"  = "#CC6677"),
                     labels = c("r_squared" = "R-squared",
                                "adj_r_squared"  = "Adjusted R-squared")) +
  labs(
    title = "Evaluation Metrics of the Multiple Linear Regression Model (by Day)",
    subtitle = "Hourly values of R-squared and Adjusted R-squared",
    x = "Hour of Day",
    y = "Metric Value",
    color = "Metric"
  ) +
...
# Save plot
ggsave("../plots/lm_metrics_by_day.png", plot = p_rk, width = 12, height = 8, dpi = 300)
```
