...
ggplot(df_long, aes(x = value, y = rk_cv_rmse)) +
  geom_point(alpha = 0.3) +
  geom_smooth(method = "lm", se = FALSE, color = "red", linewidth = 1) +
  facet_wrap(~ variable, scales = "free_x") +
  theme_minimal(base_size = 14) +
  labs(
    title = "RK LOOCV RMSE vs Other Weather Variables Captured by the Weather Stations",
    subtitle = "Timespan: 2023-07-01 00:00:00 until 2023-07-12 23:00:00",
