...
ts_to_posix <- function(ch) {
  ...
  # Otherwise, assume numeric hours since epoch
  as.POSIXct(ch * 3600, origin = "1970-01-01", tz = "Europe/Berlin")
}
...
cv_metrics <- cv_metrics %>%
  mutate(
    # Parse datetime_local (the correct column with hours)
    datetime_calc = as.POSIXct(datetime_local, tz = "Europe/Berlin"),
