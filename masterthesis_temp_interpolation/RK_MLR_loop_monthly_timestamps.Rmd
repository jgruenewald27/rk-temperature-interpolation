...
# Read LOOCV
lm_metrics <- read.csv("../Monthly_RK_2023/mlr_model_performance_summary.csv",
                       stringsAsFactors = FALSE)
# Read the cv metrics
rk_cv_metrics <- read.csv("../Monthly_RK_2023/rk_loocv_metrics.csv",
                       stringsAsFactors = FALSE)

# Read RK metrics
rk_metrics <- read.csv("../Monthly_RK_2023/rk_metrics.csv",
                       stringsAsFactors = FALSE)
